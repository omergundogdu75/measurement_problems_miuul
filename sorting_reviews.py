# Ürün sıralama denildiğinde şu farkındalığa sahip olmak gerekir;
# 1.iş bilgisi önemli olacak faktörler göz önünde bulundurulmalı
# 2.Birden fazla faktor varsa önce bunlar standartlaştırılmalı daha sonrada etki farkı varsa ağırlıkla ifade edilmedi
# 3.Literatre bakıldığında, istatiksel yöntemleri harmanlayarak kullanmak
...
###################################################
# Bu işleme göre yeteri kadar doğru olmaz
# yüzdelik değere göre 1.kazanır
